...
function toString()
{
    return "PrespectiveCamera (Position:"+this.position.toString()+" Rotation:"+this.rotation.toString()+" FOV:"+this.fov+" ScreenSize:"+this.screen_size.toString()+" VirtualSize:"+this.virtual_size.toString()+" AspectRatio:"+this.aspect_ratio+")";
}
...
PrespectiveCamera.perspectiveProjectionMatrix = function(fov, aspect, near, far)
{
    ...
    result.matrix[0][0] = -1 * result.matrix[1][1] / aspect;
